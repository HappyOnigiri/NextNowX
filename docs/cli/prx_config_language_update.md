...
LANGUAGE is "auto", "en", or "ja". With "auto", PRX reads LC_ALL, LC_MESSAGES, and LANG, and falls back to "en".
...
```
prx config language update LANGUAGE [flags]
```

### Examples

```
prx config language update ja
```
