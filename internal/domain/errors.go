...
const (
	...
	DomainErrorCodeDocumentNotText             DomainErrorCode = "document_not_text"
	DomainErrorCodeDuplicateImplementationPlan DomainErrorCode = "duplicate_implementation_plan"
